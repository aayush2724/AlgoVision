...
- **18 live algorithm tracers** — Dijkstra, BFS, DFS, Binary Search, Merge /
  ...
  pointers), Sliding Window, Kadane's Max Subarray, and memoized Fibonacci
  (DP) — every step computed by the backend from *your* input, never a
  canned animation.
