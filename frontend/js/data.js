...
export const ALGORITHMS = [
  ...
  { id: "huffman",      name: "Huffman Coding",             category: "Patterns", emoji: "🗜️", complexity: "O(n log n)", input: "text",
    hook: "How ZIP shrinks a file: give the commonest letters the shortest codes." },
  { id: "activity_selection", name: "Activity Selection",   category: "Patterns", emoji: "📅", complexity: "O(n log n)", input: "text",
